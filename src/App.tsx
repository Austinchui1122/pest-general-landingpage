...
function CaseGallery() {
  const cases = [
    ...
    },
    {
      ...
      title: '蜂巢處理專業防護',
      desc: '技術員穿著全套防護裝備進行蜂巢移除工作，確保施工安全，保護住戶及師傅不受蜂螫。',
      tag: '蜂巢處理',
    },
    {
      img: '/images/case-3.jpg',
      title: '床蝨防治蒸氣處理',
      desc: '師傅對床蝨及床底進行專業蒸氣高溫處理，有效殺滅床蝨及對蟲卵，安全無藥劑殘留。',
      tag: '床蝨防治',
    },
    {
      img: '/images/case-4.jpg',
      title: '內窺鏡檢查白蟻巢穴',
      desc: '使用專業內窺鏡深入牆身縫隙及隱蔽位置，精準檢查白蟻巢穴位置，為制定最有效除白蟻方案提供依據。',
      tag: '白蟻檢查',
    },
    {
...
function FAQ() {
  ...
  const faqs = [
    ...
    { q: '處理後多久可以回到家中？', a: '視乎施工方式，一般滯留性噴灑不需要離開，如果全屋霧化式防治，則需要離開5小時。技術員會在服務前詳細告知，確保您和家人的安全。' },
